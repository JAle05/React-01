...
ECHO "(7) SUBIR EL REPOSITORIO MASTER LOCAL AL REMOTO"
ECHO "(8) SUBIR EL REPOSITORIO MAIN LOCAL AL REMOTO"
ECHO "(9) SALIR"
...
git remote add origin "https://github.com/JAle05/React-01.git"
read -rsp $'\nPress enter to continue....'
;;
6)
clear
